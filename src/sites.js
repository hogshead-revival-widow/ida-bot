...
export default {
        ...
        selectors: {
            ...
            paywall: `${
                document.querySelector('.conversion')
                    ? '.conversion'
                    : document.querySelector('.offer-module__ps')
                    ? '.offer-module__ps'
                    : '.offer-module__red'
            }`,
            main: `${
    ...
    'www.zeit.de': {
        ...
        start: (root) => {
            root.querySelector('.paragraph--faded').classList.remove(
                'paragraph--faded'
            );
        },
        sourceParams: {
    ...
    'www.faz.net': {
        ...
        start: (root) => {
            root.querySelector('section.js-atc-ContainerPaywall ').classList.remove(
                'atc-ContainerPaywall'
            );
        },
        sourceParams: {
    ...
    'zeitung.faz.net': {
        ...
        start: (root) => {
            root.querySelector('.fade-out-to-bottom').classList.remove(
                'fade-out-to-bottom'
            );
        },
        sourceParams: {
